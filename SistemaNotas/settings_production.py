# Configurações de Produção para o Sistema de Notas
...
# SECURITY SETTINGS - CRÍTICO PARA PRODUÇÃO
...
# Define hosts permitidos
ALLOWED_HOSTS = os.getenv('ALLOWED_HOSTS', '').split(',')
if not ALLOWED_HOSTS or ALLOWED_HOSTS == ['']:
    raise ValueError("ALLOWED_HOSTS deve ser definido no arquivo .env")
...
INSTALLED_APPS = [
    ...
    # WhiteNoise deve vir antes dos apps customizados
...
# Configuração do WhiteNoise para compressão
...
LOGIN_REDIRECT_URL = 'teacher_portal:dashboard'
